...
app.layout = html.Div([
html.H1(children="BERT Question/Answer Demo"),
html.H2(children="Intel Open Model Zoo"),
html.Tr([
html.Br(),
"Ask a question to see BERT in action!",
html.H6('Website URL: https://en.wikipedia.org/wiki/BERT_(language_model)'),
...
if __name__ == '__main__':
    ...
    setup("https://en.wikipedia.org/wiki/BERT_(language_model)")
